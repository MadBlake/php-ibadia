...
class HtmlVisitor implements Visitor { public function visitText(Text $e){ echo "<p>{$e->t}</p>\n"; } public function visitImage(Image $e){ echo "<img src='{$e->p}'/>\n"; } }
$doc=[new Text("hola"), new Image("a.png")]; $v=new HtmlVisitor(); foreach($doc as $el) $el->accept($v);

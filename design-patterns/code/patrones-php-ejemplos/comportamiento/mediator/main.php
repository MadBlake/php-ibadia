...
class DialogMediator implements Mediator { public function __construct(private ?Button $b=null, private ?Checkbox $c=null){} public function set(Button $b, Checkbox $c){ $this->b=$b; $this->c=$c; } public function notify(object $s,string $e): void { if($s===$this->b && $e==='click') echo "Btn->toggle\n"; if($s===$this->c && $e==='check') echo "Chk->changed\n"; } }
